...
const LOSS_PUNISH = -20;
const DRAW_PUNISH = -20;
...
const playerBrain = () => {
	...
	var tdtrainer_options = { learning_rate: 0.001, momentum: 0.0, batch_size: 16, l2_decay: 0.01 };

	var opt = {};
	opt.temporal_window = 8;
    opt.experience_size = 100000;
    opt.start_learn_threshold = 100; // 1000 normal
    opt.gamma = 0.7;
